...
/**
  * Created by Shuxian on 10/17/16.
  */
import monad.{MonadOps}
import ingest.{Ingest, Ingestible}
...
//    implicit val titleFormat = jsonFormat1(Title.apply)
...
//    implicit val imdbFormat = jsonFormat1(Imdb.apply)
